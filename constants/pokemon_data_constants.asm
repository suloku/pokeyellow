...
; Evolution types
	const_def 1
	const EV_LEVEL ; 1
	const EV_TRADE ; 2 ; changed so EV_LEVEL and EV_TRADE are 3 byte evolution entries, so EV_ITEM can be used as index for 4 byte evolution entries if more are added
	const EV_ITEM  ; 3
